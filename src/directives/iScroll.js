...
var utils = (function () {
  ...
  me.prefixPointerEvent = function (pointerEvent) {
    var msEvent = 'MSPointer' + pointerEvent.charAt(7).toUpperCase() + pointerEvent.substr(8)
    return window.MSPointerEvent ? msEvent : pointerEvent
  }
...
IScroll.prototype = {
  ...
  resetPosition: function (time) {
    ...
    if (!this.hasVerticalScroll || this.y > 0) {
      y = 0
      this._execEvent('topBounce', this.y)
    } else if (this.y < this.maxScrollY) {
      this._execEvent('bottomBounce')
      y = this.maxScrollY
    }
